...
public class RequestFriendRecyclerAdapter extends FirestoreRecyclerAdapter<UserModel, RequestFriendRecyclerAdapter.RequestFriendModelViewHolder> {
    ...
    protected void onBindViewHolder(@NonNull RequestFriendModelViewHolder holder, int position, @NonNull UserModel model) {
        ...
        FirebaseUtil.otherUserDetails(model.getUserId()).get().addOnCompleteListener(task -> {
           if (task.isSuccessful()){
               ...
               holder.addBtn.setOnClickListener(v -> {
                   ...
                   FirebaseUtil.requestFriend(currentUserID).whereEqualTo(FirebaseUtil.KEY_USER_ID, model.getUserId()).get().addOnCompleteListener(task2 -> {
                   ...
                   FirebaseUtil.waitFriend(model.getUserId()).whereEqualTo(FirebaseUtil.KEY_USER_ID, currentUserID).get().addOnCompleteListener(task3 -> {
