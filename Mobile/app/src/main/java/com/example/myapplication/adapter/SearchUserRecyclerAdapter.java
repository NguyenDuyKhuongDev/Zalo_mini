...
//                                holder.waitFriendBtn.setVisibility(View.GONE);
                                ...
                                holder.addFriendBtn.setOnClickListener(v -> {
                                    ...
                                    arrFriend.put(FirebaseUtil.KEY_ADDRESS, model.getAddress());
                                    arrFriend.put(FirebaseUtil.KEY_BIRTHDAY, model.getBirthDay());
                                    arrFriend.put(FirebaseUtil.KEY_SCHOOL, model.getSchool());
                                    arrFriend.put(FirebaseUtil.KEY_GENDER, model.getGender());
                                    arrFriend.put(FirebaseUtil.KEY_RELATIONSHIP, model.getRelationship());
        ...
        FirebaseUtil.currentUserDetails().get().addOnCompleteListener(task -> {
            if (task.isSuccessful()){
                ...
                if (document.exists()) {
                    ...
                    myUser.put(FirebaseUtil.KEY_ADDRESS, document.getString(FirebaseUtil.KEY_ADDRESS));
                    myUser.put(FirebaseUtil.KEY_BIRTHDAY, document.getString(FirebaseUtil.KEY_BIRTHDAY));
                    myUser.put(FirebaseUtil.KEY_SCHOOL, document.getString(FirebaseUtil.KEY_SCHOOL));
                    myUser.put(FirebaseUtil.KEY_GENDER, document.getString(FirebaseUtil.KEY_GENDER));
                    myUser.put(FirebaseUtil.KEY_RELATIONSHIP, document.getString(FirebaseUtil.KEY_RELATIONSHIP));
