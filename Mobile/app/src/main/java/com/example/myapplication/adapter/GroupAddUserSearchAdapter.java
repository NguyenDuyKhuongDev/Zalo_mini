...
public class GroupAddUserSearchAdapter extends FirestoreRecyclerAdapter<UserModel, GroupAddUserSearchAdapter.GroupAddUserSearchViewHolder> {
    Context context;
    String documentId;
    private PreferenceManager preferenceManager;

    public GroupAddUserSearchAdapter(@NonNull FirestoreRecyclerOptions<UserModel> options, String documentId, Context context) {
        super(options);
    ...
    @Override
    protected void onBindViewHolder(@NonNull GroupAddUserSearchViewHolder holder, int position, @NonNull UserModel model) {
    ...
    @NonNull
    @Override
    public GroupAddUserSearchViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.recycler_item_group_search_row, parent, false);
        return new GroupAddUserSearchAdapter.GroupAddUserSearchViewHolder(view);
    }
    private void showToast(String message) {
        Toast.makeText(context, message, Toast.LENGTH_SHORT).show();
    }
    static class GroupAddUserSearchViewHolder extends RecyclerView.ViewHolder{
        TextView usernameTxt, phoneTxt, addUserGroupBtn, successAddMemberInGroup;
        ImageView profilePic;
        public GroupAddUserSearchViewHolder(@NonNull View itemView) {
            super(itemView);
