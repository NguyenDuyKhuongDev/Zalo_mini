...
public class StoryRecyclerAdapter extends FirestoreRecyclerAdapter <PostStoryModel , StoryRecyclerAdapter.StoryModelViewHolder>{
    Context context;
    private PreferenceManager preferenceManager;
    public StoryRecyclerAdapter(@NonNull FirestoreRecyclerOptions<PostStoryModel> options ,Context context) {
        super(options);
        this.context = context;
    }

    @Override
    protected void onBindViewHolder(@NonNull StoryModelViewHolder holder, int position, @NonNull PostStoryModel model) {
    ...
    @NonNull
    @Override
    public StoryModelViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.recycler_item_story_row,parent,false);

        return new StoryRecyclerAdapter.StoryModelViewHolder(view);
    }
    ...
    static class StoryModelViewHolder extends RecyclerView.ViewHolder{
        ...
        public StoryModelViewHolder(@NonNull View itemView) {
            super(itemView);
